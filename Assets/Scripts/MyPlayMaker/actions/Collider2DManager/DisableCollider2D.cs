...
[Tooltip("停用單一 Collider（便捷方法）。")]
public class DisableCollider2D : FsmStateAction
{
    [RequiredField]
    ...
    public override void OnEnter()
    {
        ...
        {
            Debug.LogError("DisableCollider2D: Collider2DManager.Instance not found in scene!");
            Finish();
            return;
        }

        Collider2DManager.Instance.DisableCollider(
