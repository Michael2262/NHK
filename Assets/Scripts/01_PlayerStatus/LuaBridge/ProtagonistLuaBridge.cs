...
public class ProtagonistLuaBridge : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        Lua.RegisterFunction("GetSocialFear", this, SymbolExtensions.GetMethodInfo(() => GetSocialFear()));
        ...
        Lua.RegisterFunction("IsSocialFearHigh", this, SymbolExtensions.GetMethodInfo(() => IsSocialFearHigh()));
    ...
    public double GetSocialFear() => GetModel()?.SocialFear ?? 0;
    ...
    public bool IsSocialFearHigh() => GetModel()?.IsSocialFearHigh() ?? false;
